# Spectre Prism public API — 0.3.2

This file is the normative public API manifest for Spectre Prism `0.3.2`.
Its package and Stack contracts target Spectre `0.3.2` from Hex.
